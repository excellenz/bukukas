...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Excellenz Dana |  Tambah Rencana Pengeluaran</title>
            ...
            <div class="col-md-12">
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Penanggung jawab"  name="penanggungjawab">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Rencana Pengeluaran Klien</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Keterangan" name="keterangan">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">tanggal</label>
                      <input type="date" class="form-control" id="exampleInputEmail1" placeholder="tanggal" name="jatuhtempo">
                    </div>
                    <div class="form-group">
             ...
             <?php 
                    if(isset($_POST['simpan'])) {
                        ...
                        $sql = mysqli_query($koneksi, "INSERT INTO klien (kode, penanggungjawab, keterangan, jatuhtempo, jumlah, jenis, keluar) VALUES ('$kode', '$penanggungjawab', '$keterangan', '$jatuhtempo', '0', 'keluar', $keluar)");
                        ...
                        if($sql) {
                            ...
                            echo "
                                ...
                                document.location.href = 'klien_keluar.php';
                                </script>";   
                        }
                    }
                ?>
