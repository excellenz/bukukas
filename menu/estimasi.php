...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Excellenz Dana | Estimasi Pendapatan</title>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                       <?php 
                                    ...
                                    $no = 1;
                                    $sql = mysqli_query($koneksi, "SELECT * FROM klien");
                    ...
                    <tr>
                      <?php 
                         ...
                         ?>
                      <td colspan="5" style="text-align: left; font-size: 17px; color: maroon;">Total Rencana Dana Masuk :</td>
                       <td style="font-size: 17px; text-align: right; "><font style="color: green;"><?php echo " Rp." . number_format($total).",-"; ?></font></td>
                     </tr>
                      <tr>

                      <td colspan="6" style="text-align: left; font-size: 17px; color: maroon;">Total Rencana Dana keluar :</td>
