...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Excellenz Dana |  Data</title>
        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                  ...
                  <a href="tambah_klien.php"><button class="btn btn.bg-olive btn-primary"><li class="fa fa-plus"></li> Tambah Data</button></a>
                </div>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                       <?php 
                          $no = 1;
                           $sql = mysqli_query($koneksi, "SELECT * FROM klien WHERE jenis = 'masuk' ");
                      ...
                      <tr>
                        ...
                        <td style="text-align: right;">
                          ...
                          <td>
                             <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="hapus_klien.php?id=<?php echo $data['kode'];?>" class="btn btn-danger btn-md" title="Hapus Data"><i class="fa fa-trash"></i></a>
                          </td>
                      </tr>
                       <?php 
                    ...
                    <tr>
                      <td colspan="4" style="text-align: left; font-size: 17px; color: maroon;">Estimasi Pemasukan :</td>
