...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Excellenz Dana |  Tambah Klien</title>
            ...
            <div class="col-md-12">
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Klien"  name="penanggungjawab">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Layanan Klien</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Layanan Klien" name="keterangan">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Jatuh Tempo</label>
                      <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Jatuh Tempo" name="jatuhtempo">
                    </div>
                    <div class="form-group">
             ...
             <?php 
                    if(isset($_POST['simpan'])) {
                        ...
                        $sql = mysqli_query($koneksi, "INSERT INTO klien (kode, penanggungjawab, keterangan, jatuhtempo, jumlah, jenis, keluar) VALUES ('$kode', '$penanggungjawab', '$keterangan', '$jatuhtempo', '$jumlah', 'masuk', 0)");
                        ...
                        if($sql) {
                            ...
                            echo "
                                ...
                                document.location.href = 'dana_klien.php';
                                </script>";   
                        }
                    }
                ?>
