      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#"> Rencana Pengeluaran Anggaran</a></li>
            ...
            <div class="box">
                <div class="box-header">
                 <div class="col-md-6">
                  ...
                  <a href="tambah_klien_keluar.php"><button class="btn btn.bg-olive btn-primary"><li class="fa fa-plus"></li> Tambah Data</button></a>
                </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                         <th>No.</th>
                         <th>Klien</th>
                         <th>Rencana Pengeluaran Klien</th>
                         <th>Tanggal</th>
                         <th>Jumlah</th>
                         <th>Aksi</th>
                      </tr>
                    ...
                    <tbody>
                       <?php 
                          $no = 1;
                           $sql = mysqli_query($koneksi, "SELECT * FROM klien WHERE jenis = 'keluar' ");
                      ...
                      <tr>
                        ...
                        <td><?php echo date('d F Y', strtotime($data['jatuhtempo'])); ?></td>
                        <td style="text-align: right;">
                             <?php echo number_format($data['keluar']).",-"; ?>
                         </td>
                          <td>
                             <a onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="hapus_klien_keluar.php?id=<?php echo $data['kode'];?>" class="btn btn-danger btn-md" title="Hapus Data"><i class="fa fa-trash"> </i></a>
                                            </td>
                      </tr>
                       <?php 
                    ...
                    <tr>
                      <td colspan="4" style="text-align: left; font-size: 17px; color: maroon;">Total rencana pengeluaran :</td>
