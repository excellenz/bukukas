...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Excellenz Dana | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="home.php" class="logo">
          ...
          <span class="logo-mini"><b>DANA</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>EXCELLENZ DANA</b></span>
        </a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="callout callout-info">
            ...
            <p><b>Excellenz Dana adalah aplikasi pencatatan keuangan Excellenz.ID secara digital. </b><br>Developer: <a href="https://excellenz.id/" target="blank"> Excellenz.ID</a></p>
          </div>
        </div>
        <!-- /.col -->
      </div>
            ...
            <dt>Fungsi:</dt>
                <dd>
                  ...
                  <ol>
                    ...
                    <li>list data klien</li>
                  </ol>
                </dd>
                <dt>Catatan Penggunaan:</dt>
                <dd>
                  Untuk menginput data jumlah dana yang dimasukan atau dikeluarkan, tidak menggunakan tanda "." (titik) dan tidak menggunakan Rp. (contoh: "100000")
                <dt>Info:</dt>
                <dd>
                  <ol>
                    <li>PHP V.7.x</li>
                   ...
                   Info lebih lanjut mengenai aplikasi:
                    <ul>
                        <li><a href="https://api.whatsapp.com/send?phone=6285724710533" target="blank"><i class="fa fa-whatsapp"></i> : 085724710533</a></li>
                        <li><a href="mailto:princekafa91@gmail.com"><i class="fa fa-envelope-o"></i> : princekafa91@gmail.com</a></li>
                    </ul>
                    <p style="text-align: center">~<i> Excellenz.ID </i><i class="fa fa-smile-o"></i>  ~</p>
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
    ...
    <!-- /.content -->
      ...
      <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
          <a href="http://excellenz.id" target="blank">Excellenz.ID</a>
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021 Excellenz Dana.</strong> All rights reserved.
      </footer>
