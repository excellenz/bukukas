...
<head>
    ...
    <title>Excellenz Financia Data</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#data_klien" id="data_klien" class="waves-effect"><i class="fa fa-th-large fa-fw" aria-hidden="true"></i><span class="hide-menu">Data Klien</span></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo date('Y'); ?> &copy; Excellenz Financial Data</footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        ...
        $.toast({
            heading: 'Selamat Datang di Data Keuangan Excellenz',
            text: 'Aplikasi pengelola Kas Keuangan by Administrator.',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
      ...
      $("#kas_masuk").click(function(){
       ...
       $("#data_klien").click(function(){
        $("#kontenku").load("<?php echo base_url ?>page/data_klien.php");
      });
