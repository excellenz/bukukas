<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Rincian Data Klien</h4> </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Rincian Data Klien</a></li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
...
<script>
	...
	function lihat_laporan() {
		...
		if (tgl_awal=='' || tgl_akhir=='' ) {
			...
			$('#isi_tabel').load('server_side/data_klien/laporan_masuk.php?tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir);
		}
